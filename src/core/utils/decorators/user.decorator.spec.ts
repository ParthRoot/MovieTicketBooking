...
import { AvailableRoleEnum, IUserPayload } from "../guard";
import { UnautherizationError } from "../error";
import { MockType } from "../type.util";

/* -----------------------User Mock------------------------------ */
export const userMockFactory: () => MockType<Repository<UserRepository>> =
  jest.fn(() => ({
...
/* -----------------------------user role assigned------------------------------------ */
export const roleAssignMockFactory: () => MockType<
  Repository<RoleAssignedRepository>
> = jest.fn(() => ({
  findOne: jest.fn((entity) => entity),
  // ...
}));
...
export const roleAvailableMockFactory: () => MockType<
  Repository<RoleAvailableRepository>
> = jest.fn(() => ({
  findOne: jest.fn((entity) => entity),
  // ...
}));
...
export const permissionMockFactory: () => MockType<
...
/*-----------------------------Start module mock-------------------------------------------- */
export const moduleMockFactory: () => MockType<Repository<ModuleRepository>> =
  jest.fn(() => ({
    findOne: jest.fn((entity) => entity),
  }));
...
export const rolePermissionMockFactory: () => MockType<
